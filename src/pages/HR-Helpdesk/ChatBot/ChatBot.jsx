...
const ChatBot = () => {
  ...
  const predefinedQuestions = (orgId) => ({
    ...
    Attendance: [
      ...
      { 
        question: "Can I raise the leaves or attendance on the behalf of an employee?", 
        answer: "Yes. By clicking on the leaves and attendance management, you can raise leaves and attendance.", 
        isPredefinedQuestion: true 
      },
      { 
        question: "How to approve leave requests of my team?", 
        answer: "You can approve leave requests in the “Notification” tab of the Leave and Attendance Module of the AEGIS HRMS after being logged in or through the notification “Bell Icon”. Click “Leave” to view the leave requests of your team and “Approve” the requests. AEGIS hrms → Leave and Attendance → Notifications → For Leave", 
        isPredefinedQuestion: true 
      },
      { 
        question: "How to reject leave requests for the team?", 
        answer: "You can reject leave requests in the “Notification” tab of the Leave and Attendance Module of the AEGIS HRMS after being logged in or through the notification “Bell Icon”. Click “Leave” to view the leave requests of your team and “Reject” the requests. AEGIS hrms → Leave and Attendance → Notifications → Leave", 
        isPredefinedQuestion: true 
      },
    ],
    FAQ: [
      { 
        ...
        answer: "Ensure your user ID and password are correct. Use 'Forgot Password' if needed.", 
        isPredefinedQuestion: true 
      },
      { 
      ...
      { 
        ...
        answer: "Yes. In the dashboard, managers can view the number of employees present and the number of employees on leave on the current date.", 
        isPredefinedQuestion: true 
      },
      { 
        question: "Can I suggest any training for my team members?", 
        answer: "Yes. You can create training and assign it by selecting employees.", 
        isPredefinedQuestion: true 
      },
    ],
  });
  ...
  const handleModuleSelect = (module) => {
    if (predefined[module]) {
      ...
      setChat((prev) => [
        ...
        { text: `Here are some questions regarding ${module}:`, isAssistant: true },
  ...
  const handleQuestionSelect = (question) => {
    const answer = predefined[selectedModule]?.find((q) => q.question === question)?.answer;
    setChat((prev) => [
      ...prev,
      { text: question, isAssistant: false },
      { text: answer || "I'm sorry, I don't have an answer for that question.", isAssistant: true },
  ...
  const handleRaiseTicket = () => {
    if (attachmentStep) {
      ...
      setChat((prev) => [
        ...prev,
        { text: "Your ticket has been successfully submitted.", isAssistant: true },
      ]);
    ...
    if (currentInputStep !== null) {
      ...
      if (currentInputStep < ticketQuestions.length - 1) {
        ...
        setChat((prev) => [
          ...prev,
          { text: `Please provide the ${ticketQuestions[currentInputStep + 1]}.`, isAssistant: true },
        ]);
      } else {
        setChat((prev) => [
          ...prev,
